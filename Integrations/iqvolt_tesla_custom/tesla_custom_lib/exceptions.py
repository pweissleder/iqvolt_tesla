...
from .const import MAX_API_RETRY_TIME
...
class TeslaException(Exception):
    ...
    def __init__(self, code: Text, *args, **kwargs) -> None:
...
class IncompleteCredentials(TeslaException):
    ...
    def __init__(self, code: Text, *args, devices: dict[Any, Any] = None, **kwargs) -> None:
