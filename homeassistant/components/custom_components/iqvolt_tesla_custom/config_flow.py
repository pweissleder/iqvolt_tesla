...
from homeassistant.const import CONF_BASE_URL, CONF_SCAN_INTERVAL, CONF_WRAPPER_API_KEY
        ...
        if user_input is not None:
            ...
            if not errors:
                if existing_entry:
                    ...
                    )  # Reload of new data/ establish new connection???
...
async def validate_input(hass: core.HomeAssistant, data) -> dict:  # Sollte Passen
    ...
    async_client = httpx.AsyncClient(
        ...
        timeout=60,
        verify=SSL_CONTEXT,  # TODO: Potential direct injection for SSL_Context
    )
