...
from tesla_custom_lib.car import *
from tesla_custom_lib.connection import *
from tesla_custom_lib.const import *
from tesla_custom_lib.exceptions import (
    TeslaException,
    custom_retry,
...
class Controller:
    ...
    async def generate_car_objects(
        ...
        filtered_vins: Optional[list[str]] = None,
    ) -> dict[str, TeslaCar]:
        ...
        async with self.__update_lock:
            if self._vehicle_list:
                ...
                for vin, online in self.get_car_online().items():
                    ...
                    if (car_vin and car_vin != vin) or vin not in self.__lock:
                        continue
    ...
    def get_updates(self, car_id: str = None, vin: str = None):
    ...
    def set_updates(
        self, car_id: str = None, vin: str = None, value: bool = False
    ) -> None:
    ...
    def get_last_update_time(self, car_id: str = None, vin: str = None):
    ...
    def set_last_update_time(
        self, car_id: str = None, vin: str = None, timestamp: float = 0
    ) -> None:
    ...
    def get_last_park_time(self, car_id: str = None, vin: str = None):
        """Get park_time.
    ...
    def get_last_wake_up_time(self, car_id: str = None, vin: str = None):
        """Get wakeup_time.
    ...
    def set_car_online(
        self, car_id: str = None, vin: str = None, online_status: bool = True
    ) -> None:
    ...
    def get_car_online(self, car_id: str = None, vin: str = None):
    ...
    def set_update_interval_vin(
        self, car_id: str = None, vin: str = None, value: int = None
    ) -> None:
    ...
    def get_update_interval_vin(self, car_id: str = None, vin: str = None) -> int:
